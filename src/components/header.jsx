      ...
      <nav class="bg-white border-gray-200 px-4 lg:px-6 py-2.5">
          <div class="flex flex-wrap justify-between items-center mx-auto max-w-screen-xl">
              ...
              <Link to="/" class="flex items-center">
                  <img src={logo} class="mr-3 h-32 logo" alt="PsychRoadMap Logo" />
                  <div class="logo-text">
                    <p class="self-center lg:text-4xl text-2xl font-semibold whitespace-nowrap">
                      PsychRoadMap <br/> 
                      <span class="lg:text-2xl text-base italic text-wrap">Mapping skills to career psych-cess!</span>
                    </p>
                  </div>
              </Link>
              ...
              <div class="hidden justify-between items-center w-full lg:flex lg:w-auto lg:order-1" id="mobile-menu">
                  <ul class="flex flex-col mt-4 lg:flex-row lg:space-x-8 lg:mt-0">
                      <li>
                        <Link to="/select" class="block lg:w-50 lg:px-5 lg:py-5 text-2xl gold border-b text-center mb-0.5 headerbutton"><b>APP</b></Link>
                      </li>
                      <li>
                        <Link to="/mission" class="block lg:w-50 lg:px-5 lg:py-5 text-2xl gold border-b text-center mb-0.5 headerbutton"><b>MISSION</b></Link>
                      </li>
                      <li>
                        <Link to="/about" class="block lg:w-50 lg:px-5 lg:py-5 text-2xl gold border-b text-center headerbutton"><b>ABOUT</b></Link>
                      </li>
                  </ul>
              </div>
          </div>
