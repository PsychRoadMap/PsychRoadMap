      ...
      <div className="select-text bg-white pb-10">
        ...
        <Accordion flush={true} alwaysOpen={true} collapseAll={true}>
          ...
          <Accordion.Panel>
            <div className="section">
              <Accordion.Title className='flex justify-between w-full gap-3'>
                <label htmlFor="PSY10000" onClick={stopProp}>
          ...
          <Accordion.Panel>
            <div className="section">
              <Accordion.Title className='flex justify-between w-full gap-3'>
                <label htmlFor="PSY30400" onClick={stopProp}>
          ...
          <Accordion.Panel>
            <div className="section">
              <Accordion.Title className='flex justify-between w-full gap-3'>
                <label htmlFor="PSY30600" onClick={stopProp}>
          ...
          <Accordion.Panel>
            <div className="section end-section">
              <Accordion.Title className='flex justify-between w-full gap-3'>
                <label htmlFor="PSY48500" onClick={stopProp}>
        ...
        <Accordion flush={true} alwaysOpen={true} collapseAll={true}>
          ...
          <Accordion.Panel>
            <div className="section">
              <Accordion.Title className='flex justify-between w-full gap-3'>
                <label htmlFor="PSY30300" onClick={stopProp}>
          ...
          <Accordion.Panel>
            <div className="section">
              <Accordion.Title className='flex justify-between w-full gap-3'>
                <label htmlFor="PSY30900" onClick={stopProp}>
          ...
          <Accordion.Panel>
            <div className="section">
              <Accordion.Title className='flex justify-between w-full gap-3'>
                <label htmlFor="PSY31100" onClick={stopProp}>
          ...
          <Accordion.Panel>
            <div className="section">
              <Accordion.Title className='flex justify-between w-full gap-3'>
                <label htmlFor="PSY32100" onClick={stopProp}>
          ...
          <Accordion.Panel>
            <div className="section end-section">
              <Accordion.Title className='flex justify-between w-full gap-3'>
                <label htmlFor="PSY32400" onClick={stopProp}>
        ...
        <Accordion flush={true} alwaysOpen={true} collapseAll={true}>
          ...
          <Accordion.Panel>
            <div className="section">
              <Accordion.Title className='flex justify-between w-full gap-3'>
                <label htmlFor="PSY31500" onClick={stopProp}>
          ...
          <Accordion.Panel>
            <div className="section">
              <Accordion.Title className='flex justify-between w-full gap-3'>
                <label htmlFor="PSY32500" onClick={stopProp}>
          ...
          <Accordion.Panel>
            <div className="section">
              <Accordion.Title className='flex justify-between w-full gap-3'>
                <label htmlFor="PSY32600" onClick={stopProp}>
          ...
          <Accordion.Panel>
            <div className="section">
              <Accordion.Title className='flex justify-between w-full gap-3'>
                <label htmlFor="PSY33000" onClick={stopProp}>
          ...
          <Accordion.Panel>
            <div className="section">
              <Accordion.Title className='flex justify-between w-full gap-3'>
                <label htmlFor="PSY33100" onClick={stopProp}>
          ...
          <Accordion.Panel>
            <div className="section">
              <Accordion.Title className='flex justify-between w-full gap-3'>
                <label htmlFor="PSY33200" onClick={stopProp}>
          ...
          <Accordion.Panel>
            <div className="section end-section">
              <Accordion.Title className='flex justify-between w-full gap-3'>
                <label htmlFor="PSY33400" onClick={stopProp}>
        ...
        <Accordion flush={true} alwaysOpen={true} collapseAll={true}>
          ...
          <Accordion.Panel>
            <div className="section">
              <Accordion.Title className="flex justify-between w-full gap-3">
                <label htmlFor="PSY20500" onClick={stopProp}>
          ...
          <Accordion.Panel>
            <div className="section">
              <Accordion.Title className="flex justify-between w-full gap-3">
                <label htmlFor="PSY20800" onClick={stopProp}>
          ...
          <Accordion.Panel>
            <div className="section">
              <Accordion.Title className="flex justify-between w-full gap-3">
                <label htmlFor="PSY21000" onClick={stopProp}>
          ...
          <Accordion.Panel>
            <div className="section">
              <Accordion.Title className="flex justify-between w-full gap-3">
                <label htmlFor="PSY31200" onClick={stopProp}>
          ...
          <Accordion.Panel>
            <div className="section">
              <Accordion.Title className="flex justify-between w-full gap-3">
                <label htmlFor="PSY31300" onClick={stopProp}>
          ...
          <Accordion.Panel>
            <div className="section end-section">
              <Accordion.Title className="flex justify-between w-full gap-3">
                <label htmlFor="PSY36500" onClick={stopProp}>
        ...
        <Accordion flush={true} alwaysOpen={true} collapseAll={true}>
          ...
          <Accordion.Panel>
            <div className="section">
              <Accordion.Title className='flex justify-between w-full gap-3'>
                <label htmlFor="PSY15700" onClick={stopProp}>
          ...
          <Accordion.Panel>
            <div className="section">
              <Accordion.Title className='flex justify-between w-full gap-3'>
                <label htmlFor="PSY18100" onClick={stopProp}>
          ...
          <Accordion.Panel>
            <div className="section">
              <Accordion.Title className='flex justify-between w-full gap-3'>
                <label htmlFor="PSY21200" onClick={stopProp}>
          ...
          <Accordion.Panel>
            <div className="section">
              <Accordion.Title className='flex justify-between w-full gap-3'>
                <label htmlFor="PSY21500" onClick={stopProp}>
          ...
          <Accordion.Panel>
            <div className="section">
              <Accordion.Title className='flex justify-between w-full gap-3'>
                <label htmlFor="PSY23500" onClick={stopProp}>
          ...
          <Accordion.Panel>
            <div className="section">
              <Accordion.Title className='flex justify-between w-full gap-3'>
                <label htmlFor="PSY30800" onClick={stopProp}>
          ...
          <Accordion.Panel>
            <div className="section">
              <Accordion.Title className='flex justify-between w-full gap-3'>
                <label htmlFor="PSY39012" onClick={stopProp}>
          ...
          <Accordion.Panel>
            <div className="section">
              <Accordion.Title className='flex justify-between w-full gap-3'>
                <label htmlFor="PSY45000" onClick={stopProp}>
          ...
          <Accordion.Panel>
            <div className="section end-section">
              <Accordion.Title className='flex justify-between w-full gap-3'>
                <label htmlFor="PSY48000" onClick={stopProp}>
